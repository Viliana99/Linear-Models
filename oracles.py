...
class BaseSmoothOracle:
    ...
    def func(self, w):
        """
        Вычисление значения функции в точке w.
        """
        raise NotImplementedError('Func oracle is not implemented.')

    def grad(self, w):
        """
         Вычисление значения градиента функции в точке w.
        """
...
class BinaryLogistic(BaseSmoothOracle):
    ...
    Оракул поддерживает l2 регуляризацию.
    """
    ...
    def func(self, X, y, w=None):
        """
         Вычисление значения функционала в точке w на выборке X с ответами y.
